...
export const MainPage: NextPage<IMainPageProps> = (props) => {
  ...
  const yourCoin = useAppContracts('YourCoin', ethersAppContext.chainId);
  const nftStaking = useAppContracts('NFTStaking', ethersAppContext.chainId);
